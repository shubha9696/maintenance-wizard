      ...
      <main className="main-content">
        ...
        <div className="page-container page-enter" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="stats-grid stagger-enter">
            ...
            <Link href="/equipment?status=healthy" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
            ...
            <Link href="/equipment?status=warning" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>

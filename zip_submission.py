        ...
        for root, dirs, files in os.walk(root_dir):
            ...
            for file in files:
                if file in exclude_files or file.startswith('.'):
                    continue
                if file in ["Maintenance_Wizard_Project_Report.pdf", "Maintenance_Wizard_Project_Report_v2.pdf", "Maintenance_Wizard_Project_Report_v3.pdf"]:
                    continue
                ...
                if file == "Maintenance_Wizard_Project_Report_v4.pdf":
